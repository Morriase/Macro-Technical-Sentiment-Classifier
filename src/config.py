...
ENSEMBLE_CONFIG = {
    "base_learners": {
        ...
        "lstm": {
            ...
            "hidden_size": 256,          # INCREASED: More capacity for stable learning
            "num_layers": 4,            # INCREASED: 2 layers for better representation
            ...
            "dropout": 0.4,             # DISABLED: Turn off dropout to reduce variance
